...
public class EmployeeObject 
{
	...
	public static void main(String[] args) 
	{
		...
		EmployeeObject obj1=new EmployeeObject("Charan","Hyd","Mumbai");
		EmployeeObject obj2=new EmployeeObject("Charu","Chennai","Mumbai");
		EmployeeObject obj3=new EmployeeObject("Shane","Hyd","Mumbai");
		System.out.println("=====================================");
